...
//-----------------------------------------------------------------------------------------
//------------------------------------- AXIS2----------------------------------------------
public static CANSparkMax Axis2Motor = new CANSparkMax(3, MotorType.kBrushless);
public static RelativeEncoder Axis2Encoder;
//-----------------------------------------------------------------------------------------
//------------------------------------- AXIS2----------------------------------------------
public static CANSparkMax Axis3Motor = new CANSparkMax(2, MotorType.kBrushless);
