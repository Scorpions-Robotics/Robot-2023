...
public class ArmModeChanger2 extends CommandBase {
  ArmSubsystem m_arm;
  ...
  public ArmModeChanger2(ArmSubsystem m_arm, XboxSubsystem m_xbox) {
    this.m_arm = m_arm;
    this.m_xbox = m_xbox;
  ...
  public void execute() {
    ...
    axis1 = m_xbox.axis1Value;
    axis2 = m_xbox.axis2Value;
    axis3 = m_xbox.axis3Value;
